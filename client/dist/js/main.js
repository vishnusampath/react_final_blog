...
var AddPostBox = React.createClass({displayName: "AddPostBox",
  componentDidMount: function(){
  ...
  render: function () {
    return(
      React.createElement("div", {className: "container"}, 
        ...
        React.createElement("div", {className: "row", id: "addPostBox"}, 
          React.createElement("div", {className: "col-md-3 pull-left"}), 
              ...
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("input", {type: "text", className: "form-control", id: "addTitle", name: "addTitle", required: true})

              ), 
              React.createElement("div", {className: "form-group"}, 

      					React.createElement("label", {for: "addTopic"}, 
      						"Topic"
      					), 
      					React.createElement("input", {type: "text", className: "form-control", id: "addTopic", name: "addTopic", required: true})

      				), 
              React.createElement("div", {className: "form-group"}, 

      					React.createElement("label", {for: "addText"}, 
      						"Details"
      					), 
      					React.createElement("textarea", {type: "text", className: "form-control", id: "addPlot", name: "addText", required: true})

      				), 
      				React.createElement("div", {className: "form-group"}, 

                React.createElement("label", {for: "addAuthor"}, 
                  "Author"
                ), 
                React.createElement("input", {type: "text", className: "form-control", id: "addAuthor", name: "addAuthor", required: true})
              ...
              React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("input", {type: "file", className: "form-control", id: "addPoster", name: "addPoster", required: true})

      				)
      			), 
            React.createElement("center", null, 
            React.createElement("button", {className: "btn btn-primary", id: "addPostButton"}, 
              "Add New Post"
            )
            )
      		), 
...
},{"./NavigationBar":206,"react":199,"react-router":35}],201:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
var NavigationBar=require('./NavigationBar');

var CategoryPhysicsBox = React.createClass({displayName: "CategoryPhysicsBox",
  ...
  render: function () {
    return(
      React.createElement("div", {className: "container", id: "mainCategoryBox"}, 
        React.createElement(NavigationBar, null), 
        React.createElement(MainCategoryBox, {jsonData: this.state.categoryJSONArray})
      )
    );
  }
});

var MainCategoryBox = React.createClass({displayName: "MainCategoryBox",

  render: function () {
    var postrows = [];
    this.props.jsonData.forEach(function (post){
       postrows.push(React.createElement(CategoryPost, {key: post._id, postObj: post}));
     }.bind(this));

    return(React.createElement("div", null, postrows));
  }
});

var CategoryPost = React.createClass({displayName: "CategoryPost",
  getInitialState: function () {
  ...
  render: function(){
      return(
        React.createElement("div", {className: "row wrap-content", id: "postElement"}, 
          React.createElement("div", {className: "col-md-4"}, 
             React.createElement("img", {id: "overviewposter", alt: "Bootstrap Image Preview", src: this.props.postObj.poster})
          ), 
            ...
            React.createElement("div", {className: "list-group", id: "list-group"}, 
              React.createElement("div", {className: "list-group-item", id: "list-group-item"}, 
                React.createElement("ul", {className: "list-unstyled", id: "ulist"}, 
                  ...
                  React.createElement("li", {id: "overview-text"}, 
                    this.props.postObj.text
                  ), 

                  React.createElement("li", {id: "author"}, 
                    React.createElement("span", null, "Posted by :  "), " ", this.props.postObj.author_name
                  )
                ), 
                React.createElement("input", {type: "text", id: "postID", value: this.props.postObj._id, hidden: true, readOnly: true}), 
                React.createElement("div", {className: "buttons"}, 
                  React.createElement(Link, {to: '/fullpost/'+this.props.postObj._id, className: "btn btn-primary"}, " Read more... ")
                )
              )
            )
          )
...
module.exports = CategoryPhysicsBox;
},{"./NavigationBar":206,"react":199,"react-router":35}],202:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
var NavigationBar=require('./NavigationBar');

var CategorySpaceBox = React.createClass({displayName: "CategorySpaceBox",
...
},{"./NavigationBar":206,"react":199,"react-router":35}],203:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
var NavigationBar=require('./NavigationBar');

var CategoryTechBox = React.createClass({displayName: "CategoryTechBox",
...
module.exports = CategoryTechBox;
},{"./NavigationBar":206,"react":199,"react-router":35}],204:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
var NavigationBar=require('./NavigationBar');
  ...
  render: function(){
      return(
        React.createElement("div", {className: "container", id: "fullPostBox"}, 
          ...
          React.createElement("div", {className: "row wrap-content", id: "postElement"}, 
            React.createElement("div", {className: "col-md-4"}, 
               React.createElement("img", {id: "poster", alt: "Bootstrap Image Preview", src: this.state.postObj.poster})
            ), 
            React.createElement("div", {className: "col-md-8"}, 
              React.createElement("div", {className: "list-group", id: "list-group"}, 
                React.createElement("div", {className: "list-group-item", id: "list-group-item"}, 
                  React.createElement("ul", {className: "list-unstyled", id: "ulist"}, 
                    ...
                    React.createElement("li", {id: "author"}, 
                      React.createElement("span", null, "Posted by :  "), " ", this.state.postObj.author_name
                    )
                  ), 
...
},{"./NavigationBar":206,"react":199,"react-router":35}],205:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
var NavigationBar=require('./NavigationBar');

var MainBlogBox = React.createClass({displayName: "MainBlogBox",
  ...
  render: function () {
    return(
      React.createElement("div", {className: "container", id: "mainBox"}, 
        React.createElement(NavigationBar, null), 
        React.createElement(MainBox, {jsonData: this.state.blogJSONArray})
      )
    );
  }
});
...
var MainBox = React.createClass({displayName: "MainBox",
  ...
  render: function () {
    var postrows = [];
    this.props.jsonData.forEach(function (post){
       postrows.push(React.createElement(BlogPost, {key: post._id, postObj: post, onReadPost: this.readPostByID}));
     }.bind(this));
...
},{"./NavigationBar":206,"react":199,"react-router":35}],206:[function(require,module,exports){
var React = require('react');
var Link = require('react-router').Link;
        ...
        React.createElement("div", {className: "container", id: "navbar"}, 
          React.createElement("div", {className: "navbar-collapse collapse navbar-responsive-collapse"}, 
            React.createElement("ul", {className: "nav navbar-nav", id: "navbar-list"}, 
              React.createElement("li", {className: "active"}, React.createElement(Link, {to: "/"}, "Posts")), 
              React.createElement("li", null, " ", React.createElement("span", null, " | "), " "), 
              React.createElement("li", null, React.createElement(Link, {to: "/categorySpace/Space"}, "Space")), 
              React.createElement("li", null, " ", React.createElement("span", null, " | "), " "), 
              React.createElement("li", null, React.createElement(Link, {to: "/categoryTech/Tech"}, "Tech")), 
              React.createElement("li", null, " ", React.createElement("span", null, " | "), " "), 
              React.createElement("li", null, React.createElement(Link, {to: "/categoryPhysics/Physics"}, "Physics"))
            ), 
            React.createElement("ul", {className: "nav navbar-nav pull-right", id: "navbar-list"}, 
              React.createElement("li", null, React.createElement(Link, {to: "/addpost"}, "Add Post"))
            )
          )
        )
      )
...
},{"react":199,"react-router":35}],207:[function(require,module,exports){
var React = require('react');
...
},{"./routes.js":208,"react":199,"react-dom":10,"react-router":35}],208:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
module.exports = (
  React.createElement(Route, null, 
    React.createElement(Route, {path: "/", handler: MainBlogBox}), 
    React.createElement(Route, {path: "/categorySpace/:topic", handler: CategorySpaceBox}), 
    React.createElement(Route, {path: "/categoryTech/:topic", handler: CategoryTechBox}), 
    React.createElement(Route, {path: "/categoryPhysics/:topic", handler: CategoryPhysicsBox}), 
    React.createElement(Route, {path: "/fullpost/:_id", handler: FullPostBox}), 
    React.createElement(Route, {path: "/addpost", handler: AddPostBox})
  )
);
},{"./components/AddPostBox":200,"./components/CategoryPhysicsBox":201,"./components/CategorySpaceBox":202,"./components/CategoryTechBox":203,"./components/FullPostBox":204,"./components/MainBlogBox":205,"react":199,"react-router":35}]},{},[207]);
